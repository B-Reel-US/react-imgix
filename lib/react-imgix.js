...
var buildSrcSetPairWithFixedHeight = function buildSrcSetPairWithFixedHeight(url, ext, targetWidth, fixedHeight, _) {
  return url + "&h=" + fixedHeight + "&w=" + targetWidth + ext + " " + targetWidth + "w";
};

var buildSrcSetPairWithTargetWidth = function buildSrcSetPairWithTargetWidth(url, ext, targetWidth, _1, _2) {
  return url + "&w=" + targetWidth + ext + " " + targetWidth + "w";
};

var buildDprSrcWithQuality = function buildDprSrcWithQuality(url, ext, quality, dpr) {
  return url + "&q=" + quality + "&dpr=" + dpr + ext + " " + dpr + "x";
};

var buildDprSrcWithoutQuality = function buildDprSrcWithoutQuality(url, ext, _, dpr) {
  return url + "&dpr=" + dpr + ext + " " + dpr + "x";
};

var buildDprSrcWithQualityByDpr = function buildDprSrcWithQualityByDpr(url, ext, quality, dpr) {
  return url + "&q=" + quality + "&dpr=" + dpr + ext + " " + dpr + "x";
};
/**
...
function buildSrc(_ref) {
  ...
  if (disableSrcSet) {
    ...
    if (fixedSize) {
      ...
      for (var _i2 = 0; _i2 < len; _i2++) {
        ...
        srcSet += srcFn(constructedUrl, ext, q || quality, _i2 + 1) + ", ";
      }
      ...
      for (var _i3 = 0; _i3 < _len; _i3++) {
        ...
        srcSet += _srcFn(_constructedUrl, ext, targetWidth, _height) + ", ";
      }
  ...
  if (_common.config.debugUrl) {
    ...
    urls.map(function (url) {
      ...
      if (cleanUrl.match(/&$/)) return console.log("[ react-imgix ] :: ".concat(cleanUrl.slice(0, -1)));else return console.log("[ react-imgix ] :: ".concat(cleanUrl));
    });
  }
...
function (_Component) {
  ...
  function ReactImgix(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ReactImgix).call(this, props));
    _this.imgRef = null;
    return _this;
  }
...
function (_Component2) {
  ...
  function PictureImpl(props) {
    ...
    _this3 = _possibleConstructorReturn(this, _getPrototypeOf(PictureImpl).call(this, props));
...
function (_Component3) {
  ...
  function SourceImpl(props) {
    ...
    _this5 = _possibleConstructorReturn(this, _getPrototypeOf(SourceImpl).call(this, props));
